package br.com.rabbit.producer.configs;
...
public class RabbitMQConfig {
	...
	public static final String RK_PRODUTO_LOG = "product.log";
	...
	public Binding binding() {
		return BindingBuilder.bind(queue()).to(directExchange()).with(RK_PRODUTO_LOG);
	}
